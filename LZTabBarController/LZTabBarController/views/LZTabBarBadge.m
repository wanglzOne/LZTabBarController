...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        NSString *bundlePath = [[NSBundle bundleForClass:self.class] pathForResource:@"LZTabBarController" ofType:@"bundle"];
        NSString *imagePath = [bundlePath stringByAppendingPathComponent:@"LZTabBarBadge@2x.png"];
